...
return [
    ...
    'settings.use_own_color_theme.label' => 'Use your own color theme',
    ...
    'settings.use_own_color_theme.instructions' => 'Allows you to overwrite Intercom\'s color settings and set your own "{action_color}" and "{background_color}" above.',
